...
public class FConstants {
    static {
        ...
        FollowerConstants.translationalPIDFCoefficients = new CustomPIDFCoefficients(0.2, 0, 0.03, 0);
        ...
        FollowerConstants.headingPIDFCoefficients = new CustomPIDFCoefficients(0.65, 0, 0.055, 0);
        ...
        FollowerConstants.drivePIDFCoefficients = new CustomFilteredPIDFCoefficients(0.009, 0, 0.0007, 0.6, 0);
        ...
        FollowerConstants.zeroPowerAccelerationMultiplier = 1; // maybe set this to 2
        FollowerConstants.centripetalScaling = 0.0003;

        FollowerConstants.pathEndTimeoutConstraint = 500; // in ms
        FollowerConstants.pathEndTValueConstraint = 0.995;
        FollowerConstants.pathEndVelocityConstraint = 0.1; // TODO: apparently setting this to 3 can fix overshoot issues if we come across them.
